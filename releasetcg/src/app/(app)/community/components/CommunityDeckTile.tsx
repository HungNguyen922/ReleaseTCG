...
export default function CommunityDeckTile({ deck }: Props) {
  const hasCover = deck.coverCardNumber && deck.coverSetName;

  return (
    <Link href={`/community/${deck.id}`}>
      <div className="overflow-hidden rounded-xl border bg-card transition-all hover:-translate-y-1 hover:border-primary hover:shadow-lg">
